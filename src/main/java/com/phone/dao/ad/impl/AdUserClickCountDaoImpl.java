...
import com.phone.dao.ad.IAdUserClickCountDao;
...
/**
 * @Description: TODO 统计每天各用户对各广告的点击次数功能接口实现类
 * @ClassName: AdUserClickCountDaoImpl
 * @Author: xqg
 * @Date: 2018/12/2 15:25
 */
public class AdUserClickCountDaoImpl implements IAdUserClickCountDao {
    ...
    public void updateBatch(List<AdUserClickCount> beans) {
        ...
        try {
            ...
            List<AdUserClickCount> updateContainer = new LinkedList<>();
            List<AdUserClickCount> insertContainer = new LinkedList<>();
